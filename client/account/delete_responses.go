...
func (o *DeleteOK) Error() string {
	return fmt.Sprintf("[POST /kf/account/del][%d] deleteOK  %+v", 200, o.Payload)
}
...
func (o *DeleteOK) GetPayload() *models.DelCustomerServiceAccountReponse {
	return o.Payload
}
...
func (o *DeleteDefault) Error() string {
	return fmt.Sprintf("[POST /kf/account/del][%d] delete default  %+v", o._statusCode, o.Payload)
}
...
func (o *DeleteDefault) GetPayload() *models.ErrorModel {
	return o.Payload
}
