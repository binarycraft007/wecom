...
// WithListCustomerServiceAccountRequest adds the listCustomerServiceAccountRequest to the list params
func (o *ListParams) WithListCustomerServiceAccountRequest(listCustomerServiceAccountRequest *models.ListCustomerServiceAccountRequest) *ListParams {
	o.SetListCustomerServiceAccountRequest(listCustomerServiceAccountRequest)
	return o
}

// SetListCustomerServiceAccountRequest adds the listCustomerServiceAccountRequest to the list params
func (o *ListParams) SetListCustomerServiceAccountRequest(listCustomerServiceAccountRequest *models.ListCustomerServiceAccountRequest) {
