...
// WithUpdateCustomerServiceAccountRequest adds the updateCustomerServiceAccountRequest to the update params
func (o *UpdateParams) WithUpdateCustomerServiceAccountRequest(updateCustomerServiceAccountRequest *models.UpdateCustomerServiceAccountRequest) *UpdateParams {
	o.SetUpdateCustomerServiceAccountRequest(updateCustomerServiceAccountRequest)
	return o
}

// SetUpdateCustomerServiceAccountRequest adds the updateCustomerServiceAccountRequest to the update params
func (o *UpdateParams) SetUpdateCustomerServiceAccountRequest(updateCustomerServiceAccountRequest *models.UpdateCustomerServiceAccountRequest) {
