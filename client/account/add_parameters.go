...
// WithAddCustomerServiceAccountRequest adds the addCustomerServiceAccountRequest to the add params
func (o *AddParams) WithAddCustomerServiceAccountRequest(addCustomerServiceAccountRequest *models.AddCustomerServiceAccountRequest) *AddParams {
	o.SetAddCustomerServiceAccountRequest(addCustomerServiceAccountRequest)
	return o
}

// SetAddCustomerServiceAccountRequest adds the addCustomerServiceAccountRequest to the add params
func (o *AddParams) SetAddCustomerServiceAccountRequest(addCustomerServiceAccountRequest *models.AddCustomerServiceAccountRequest) {
