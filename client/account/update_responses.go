...
func (o *UpdateOK) Error() string {
	return fmt.Sprintf("[POST /kf/account/update][%d] updateOK  %+v", 200, o.Payload)
}
...
func (o *UpdateOK) GetPayload() *models.UpdateCustomerServiceAccountReponse {
	return o.Payload
}
...
func (o *UpdateDefault) Error() string {
	return fmt.Sprintf("[POST /kf/account/update][%d] update default  %+v", o._statusCode, o.Payload)
}
...
func (o *UpdateDefault) GetPayload() *models.ErrorModel {
	return o.Payload
}
