...
// WithCorpid adds the corpid to the get params
func (o *GetParams) WithCorpid(corpid string) *GetParams {
	o.SetCorpid(corpid)
	return o
}

// SetCorpid adds the corpid to the get params
func (o *GetParams) SetCorpid(corpid string) {
	o.Corpid = corpid
}

// WithCorpsecret adds the corpsecret to the get params
func (o *GetParams) WithCorpsecret(corpsecret string) *GetParams {
	o.SetCorpsecret(corpsecret)
	return o
}

// SetCorpsecret adds the corpsecret to the get params
func (o *GetParams) SetCorpsecret(corpsecret string) {
