...
func (o *GetOK) Error() string {
	return fmt.Sprintf("[GET /gettoken][%d] getOK  %+v", 200, o.Payload)
}
...
func (o *GetOK) GetPayload() *models.GetAccessTokenReponse {
	return o.Payload
}
...
func (o *GetDefault) Error() string {
	return fmt.Sprintf("[GET /gettoken][%d] get default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetDefault) GetPayload() *models.ErrorModel {
	return o.Payload
}
