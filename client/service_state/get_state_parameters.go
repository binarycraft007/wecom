...
type GetStateParams struct {
	...
	/* GetServiceStateRequest.
	   ...
	   get service state request
	*/
	GetServiceStateRequest *models.GetServiceStateRequest
...
// WithGetServiceStateRequest adds the getServiceStateRequest to the get state params
func (o *GetStateParams) WithGetServiceStateRequest(getServiceStateRequest *models.GetServiceStateRequest) *GetStateParams {
	o.SetGetServiceStateRequest(getServiceStateRequest)
	return o
}

// SetGetServiceStateRequest adds the getServiceStateRequest to the get state params
func (o *GetStateParams) SetGetServiceStateRequest(getServiceStateRequest *models.GetServiceStateRequest) {
	o.GetServiceStateRequest = getServiceStateRequest
}
...
func (o *GetStateParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.GetServiceStateRequest != nil {
		if err := r.SetBodyParam(o.GetServiceStateRequest); err != nil {
			return err
		}
	}
