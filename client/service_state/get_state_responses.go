...
get service state response
*/
type GetStateOK struct {
	Payload *models.GetServiceStateReponse
}
...
func (o *GetStateOK) Error() string {
	return fmt.Sprintf("[POST /kf/service_state/get][%d] getStateOK  %+v", 200, o.Payload)
}
...
func (o *GetStateDefault) Error() string {
	return fmt.Sprintf("[POST /kf/service_state/get][%d] getState default  %+v", o._statusCode, o.Payload)
}
...
func (o *GetStateDefault) GetPayload() *models.ErrorModel {
	return o.Payload
}
