...
// WithCorpid adds the corpid to the get token params
func (o *GetTokenParams) WithCorpid(corpid string) *GetTokenParams {
	o.SetCorpid(corpid)
	return o
}

// SetCorpid adds the corpid to the get token params
func (o *GetTokenParams) SetCorpid(corpid string) {
	o.Corpid = corpid
}

// WithCorpsecret adds the corpsecret to the get token params
func (o *GetTokenParams) WithCorpsecret(corpsecret string) *GetTokenParams {
	o.SetCorpsecret(corpsecret)
	return o
}

// SetCorpsecret adds the corpsecret to the get token params
func (o *GetTokenParams) SetCorpsecret(corpsecret string) {
	o.Corpsecret = corpsecret
}
...
func (o *GetTokenParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if qCorpid != "" {
		...
		if err := r.SetQueryParam("corpid", qCorpid); err != nil {
			return err
		}
	}

	// query param corpsecret
	qrCorpsecret := o.Corpsecret
	qCorpsecret := qrCorpsecret
	if qCorpsecret != "" {

		if err := r.SetQueryParam("corpsecret", qCorpsecret); err != nil {
			return err
		}
	}
